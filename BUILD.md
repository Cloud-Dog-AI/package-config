...
## Package
`cloud-dog-config` - configuration loading and env-file precedence helpers.
...
```bash
python -c "import cloud_dog_config; print('package import ok')"
```
...
docker build -t cloud-dog-config:latest .
```
