...
def parse_env_file(path: str) -> dict[str, str]:
    ...
    for raw_line in p.read_text(encoding="utf-8").splitlines():
        ...
        result[key] = _normalise_placeholder_escapes(value)
...
def _normalise_placeholder_escapes(value: str) -> str:
    """Collapse Docker/shell-safe placeholder escapes back to canonical `${...}` form."""
